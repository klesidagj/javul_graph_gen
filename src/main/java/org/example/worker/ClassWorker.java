...
public class ClassWorker {
    ...
    private static final Logger log = Logger.getLogger(ClassWorker.class.getName());
    private final Config cfg;
    private final GraphExtractorImpl extractor;
    public ClassWorker(Config cfg) {
        this.cfg = cfg;
    ...
    public void run() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            while (rs.next()) {
                ...
                log.info("Processing Juliet/OWASP id=" + id);
                ...
                if (++processed % cfg.getBatchSize() == 0) {
                    upd.executeBatch();
                    conn.commit();
                    log.info("Committed CLASS batch at " + processed + " rows");
                    batch = 0;
                }
            }
            ...
            log.info("ClassWorker completed. Total processed: " + processed);
        }
    }
}